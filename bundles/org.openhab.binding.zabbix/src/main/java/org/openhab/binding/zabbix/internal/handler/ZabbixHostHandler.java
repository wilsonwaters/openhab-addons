...
public class ZabbixHostHandler extends ZabbixBaseThingHandler {
    ...
    public ZabbixHostHandler(Thing thing) {
        super(thing);
    }

    @Override
    protected String getDescription() {
        return "Zabbix host: " + (config != null ? config.config1 : "unconfigured");
    }

    @Override
    public void refresh(ZabbixServerConfiguration zabbixServerConfiguration) {
        // updateData(zabbixServerConfiguration, config);
        updateChannels();
    }

    @Override
    protected Object getValue(@Nullable String channelId) {
        return new Object();
    }
    ...
    public void initialize() {
        ...
        config = getConfigAs(ZabbixHostConfiguration.class);
